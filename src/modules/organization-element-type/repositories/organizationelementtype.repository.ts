...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class OrganizationElementTypeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[OrganizationElementType[], number]> {
      logger.info('Ready to findByField OrganizationElementType on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of OrganizationElementType with id:  was finded on repository:', instance);
