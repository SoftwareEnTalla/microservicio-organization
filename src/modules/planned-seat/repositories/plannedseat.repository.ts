...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class PlannedSeatRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[PlannedSeat[], number]> {
      logger.info('Ready to findByField PlannedSeat on repository:',where);
    ...
    async findOne(where?: Record<string, any>): Promise<PlannedSeat | null> {
      const tmp: FindOptionsWhere<PlannedSeat> = where as FindOptionsWhere<PlannedSeat>;
      logger.info('Ready to findOneBy PlannedSeat on repository with conditions:', tmp);
    ...
    async update(
        ...
        logger.info('Updated instance of PlannedSeat with id:  was finded on repository:', instance);
