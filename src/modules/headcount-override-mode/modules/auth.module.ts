...
@Module({
  controllers: [HeadcountOverrideModeCommandController],
  providers: [
  ...
  exports: [HeadcountOverrideModeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthHeadcountOverrideModeModule {}
