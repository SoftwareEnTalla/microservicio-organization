...
@Module({
  controllers: [OrganizationNodeStatusCommandController],
  providers: [
  ...
  exports: [OrganizationNodeStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthOrganizationNodeStatusModule {}
