...
@Module({
  controllers: [OrganizationNodeCommandController],
  providers: [
  ...
  exports: [OrganizationNodeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthOrganizationNodeModule {}
