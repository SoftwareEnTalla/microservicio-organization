...
@Module({
  controllers: [HeadcountOverrideStatusCommandController],
  providers: [
  ...
  exports: [HeadcountOverrideStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthHeadcountOverrideStatusModule {}
