...
import { NodeAssignmentActionCreatedEvent } from './nodeassignmentactioncreated.event';
import { NodeAssignmentActionUpdatedEvent } from './nodeassignmentactionupdated.event';
import { NodeAssignmentActionDeletedEvent } from './nodeassignmentactiondeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'node-assignment-action-created': createEventDefinition('node-assignment-action-created', NodeAssignmentActionCreatedEvent, EVENT_DEFINITION_OVERRIDES['node-assignment-action-created']),
  'node-assignment-action-updated': createEventDefinition('node-assignment-action-updated', NodeAssignmentActionUpdatedEvent, EVENT_DEFINITION_OVERRIDES['node-assignment-action-updated']),
  'node-assignment-action-deleted': createEventDefinition('node-assignment-action-deleted', NodeAssignmentActionDeletedEvent, EVENT_DEFINITION_OVERRIDES['node-assignment-action-deleted']),
