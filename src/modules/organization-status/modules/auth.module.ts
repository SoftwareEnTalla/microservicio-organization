...
@Module({
  controllers: [OrganizationStatusCommandController],
  providers: [
  ...
  exports: [OrganizationStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthOrganizationStatusModule {}
