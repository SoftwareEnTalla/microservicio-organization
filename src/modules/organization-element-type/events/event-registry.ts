...
import { OrganizationElementTypeCreatedEvent } from './organizationelementtypecreated.event';
import { OrganizationElementTypeUpdatedEvent } from './organizationelementtypeupdated.event';
import { OrganizationElementTypeDeletedEvent } from './organizationelementtypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'organization-element-type-created': createEventDefinition('organization-element-type-created', OrganizationElementTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['organization-element-type-created']),
  'organization-element-type-updated': createEventDefinition('organization-element-type-updated', OrganizationElementTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['organization-element-type-updated']),
  'organization-element-type-deleted': createEventDefinition('organization-element-type-deleted', OrganizationElementTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['organization-element-type-deleted']),
