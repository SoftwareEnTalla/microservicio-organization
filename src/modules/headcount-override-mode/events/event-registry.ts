...
import { HeadcountOverrideModeCreatedEvent } from './headcountoverridemodecreated.event';
import { HeadcountOverrideModeUpdatedEvent } from './headcountoverridemodeupdated.event';
import { HeadcountOverrideModeDeletedEvent } from './headcountoverridemodedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'headcount-override-mode-created': createEventDefinition('headcount-override-mode-created', HeadcountOverrideModeCreatedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-mode-created']),
  'headcount-override-mode-updated': createEventDefinition('headcount-override-mode-updated', HeadcountOverrideModeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-mode-updated']),
  'headcount-override-mode-deleted': createEventDefinition('headcount-override-mode-deleted', HeadcountOverrideModeDeletedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-mode-deleted']),
