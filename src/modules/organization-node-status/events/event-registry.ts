...
import { OrganizationNodeStatusCreatedEvent } from './organizationnodestatuscreated.event';
import { OrganizationNodeStatusUpdatedEvent } from './organizationnodestatusupdated.event';
import { OrganizationNodeStatusDeletedEvent } from './organizationnodestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'organization-node-status-created': createEventDefinition('organization-node-status-created', OrganizationNodeStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['organization-node-status-created']),
  'organization-node-status-updated': createEventDefinition('organization-node-status-updated', OrganizationNodeStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['organization-node-status-updated']),
  'organization-node-status-deleted': createEventDefinition('organization-node-status-deleted', OrganizationNodeStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['organization-node-status-deleted']),
