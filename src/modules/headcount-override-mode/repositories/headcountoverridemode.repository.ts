...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class HeadcountOverrideModeRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[HeadcountOverrideMode[], number]> {
      logger.info('Ready to findByField HeadcountOverrideMode on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of HeadcountOverrideMode with id:  was finded on repository:', instance);
