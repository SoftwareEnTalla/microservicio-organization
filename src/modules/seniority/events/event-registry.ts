...
import { SeniorityCreatedEvent } from './senioritycreated.event';
import { SeniorityUpdatedEvent } from './seniorityupdated.event';
import { SeniorityDeletedEvent } from './senioritydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'seniority-created': createEventDefinition('seniority-created', SeniorityCreatedEvent, EVENT_DEFINITION_OVERRIDES['seniority-created']),
  'seniority-updated': createEventDefinition('seniority-updated', SeniorityUpdatedEvent, EVENT_DEFINITION_OVERRIDES['seniority-updated']),
  'seniority-deleted': createEventDefinition('seniority-deleted', SeniorityDeletedEvent, EVENT_DEFINITION_OVERRIDES['seniority-deleted']),
