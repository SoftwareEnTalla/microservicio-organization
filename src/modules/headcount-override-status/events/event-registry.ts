...
import { HeadcountOverrideStatusCreatedEvent } from './headcountoverridestatuscreated.event';
import { HeadcountOverrideStatusUpdatedEvent } from './headcountoverridestatusupdated.event';
import { HeadcountOverrideStatusDeletedEvent } from './headcountoverridestatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'headcount-override-status-created': createEventDefinition('headcount-override-status-created', HeadcountOverrideStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-status-created']),
  'headcount-override-status-updated': createEventDefinition('headcount-override-status-updated', HeadcountOverrideStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-status-updated']),
  'headcount-override-status-deleted': createEventDefinition('headcount-override-status-deleted', HeadcountOverrideStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['headcount-override-status-deleted']),
