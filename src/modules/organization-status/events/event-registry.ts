...
import { OrganizationStatusCreatedEvent } from './organizationstatuscreated.event';
import { OrganizationStatusUpdatedEvent } from './organizationstatusupdated.event';
import { OrganizationStatusDeletedEvent } from './organizationstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'organization-status-created': createEventDefinition('organization-status-created', OrganizationStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['organization-status-created']),
  'organization-status-updated': createEventDefinition('organization-status-updated', OrganizationStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['organization-status-updated']),
  'organization-status-deleted': createEventDefinition('organization-status-deleted', OrganizationStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['organization-status-deleted']),
