...
import { NodeTypeCreatedEvent } from './nodetypecreated.event';
import { NodeTypeUpdatedEvent } from './nodetypeupdated.event';
import { NodeTypeDeletedEvent } from './nodetypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'node-type-created': createEventDefinition('node-type-created', NodeTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['node-type-created']),
  'node-type-updated': createEventDefinition('node-type-updated', NodeTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['node-type-updated']),
  'node-type-deleted': createEventDefinition('node-type-deleted', NodeTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['node-type-deleted']),
