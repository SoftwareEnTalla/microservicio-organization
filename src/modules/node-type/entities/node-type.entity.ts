...
@Index('idx_node_type_code', ['code'], { unique: true })
@Unique('uq_node_type_code', ['code'])
...
export class NodeType extends BaseEntity {
  @ApiProperty({
    type: String,
    nullable: false,
    description: "Nombre de la instancia de NodeType",
  })
  @IsString()
  @IsNotEmpty()
  @Field(() => String, { description: "Nombre de la instancia de NodeType", nullable: false })
  @Column({ type: 'varchar', length: 100, nullable: false, comment: 'Este es un campo para nombrar la instancia NodeType' })
  private name!: string;

  @ApiProperty({
    type: String,
    description: "Descripción de la instancia de NodeType",
  })
  @IsString()
  @IsNotEmpty()
  @Field(() => String, { description: "Descripción de la instancia de NodeType", nullable: false })
  @Column({ type: 'varchar', length: 255, nullable: false, default: "Sin descripción", comment: 'Este es un campo para describir la instancia NodeType' })
  ...
  static fromDto(dto: CreateNodeTypeDto): NodeType;
  static fromDto(dto: UpdateNodeTypeDto): NodeType;
  static fromDto(dto: DeleteNodeTypeDto): NodeType;
  static fromDto(dto: any): NodeType {
    // plainToInstance soporta todos los DTOs
    return plainToInstance(NodeType, dto);
  }
}
