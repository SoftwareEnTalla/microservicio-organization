...
import { OrganizationAppModule } from "./app.module";
...
async function bootstrap() {
  ...
  try {
    ...
    logger.info(`ℹCreando instancia del módulo OrganizationAppModule...`);
    const app = await NestFactory.create(OrganizationAppModule, {
    ...
    const swaggerPath = setupSwagger(
      ...
      "API completa para gestión de Organizations con documentación automática",
      "1.0"
    );
