...
import { DeleteOrganizationTypeCommand } from "../deleteorganizationtype.command";
...
export class DeleteOrganizationTypeHandler
  implements ICommandHandler<DeleteOrganizationTypeCommand>
{
  constructor(
    private readonly commandService: OrganizationTypeCommandService
  ) {}
  async execute(command: DeleteOrganizationTypeCommand) {
