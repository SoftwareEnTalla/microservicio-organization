...
import { OrganizationTypeCreatedEvent } from './organizationtypecreated.event';
import { OrganizationTypeUpdatedEvent } from './organizationtypeupdated.event';
import { OrganizationTypeDeletedEvent } from './organizationtypedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'organization-type-created': createEventDefinition('organization-type-created', OrganizationTypeCreatedEvent, EVENT_DEFINITION_OVERRIDES['organization-type-created']),
  'organization-type-updated': createEventDefinition('organization-type-updated', OrganizationTypeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['organization-type-updated']),
  'organization-type-deleted': createEventDefinition('organization-type-deleted', OrganizationTypeDeletedEvent, EVENT_DEFINITION_OVERRIDES['organization-type-deleted']),
